...
public class FeaturesConfig
{
    ...
    private boolean arrayIndexStartWithZero;
    ...
    public boolean isArrayIndexStartWithZero()
    {
        return arrayIndexStartWithZero;
    }

    @Config("array-index-start-with-zero")
    @ConfigDescription("array index starts with zero")
    public FeaturesConfig setArrayIndexStartWithZero(boolean arrayIndexStartWithZero)
    {
        this.arrayIndexStartWithZero = arrayIndexStartWithZero;
        return this;
    }
}
