...
public final class SystemSessionProperties
    ...
    public static final String ENABLE_ESCAPE_DDL = "enable_quoted_ddl";
    public static final String ARRAY_INDEX_START_WITH_ZERO = "array-index-start-with-zero";
    ...
    public SystemSessionProperties(
        ...
        sessionProperties = ImmutableList.of(
                ...
                booleanProperty(
                        ENABLE_ESCAPE_DDL,
                        "Sets whether to escape special characters for table names and table fields",
                      false,
                        true),
                booleanProperty(
                        ARRAY_INDEX_START_WITH_ZERO,
                        "Sets whether to escape special characters for table names and table fields",
                        featuresConfig.isArrayIndexStartWithZero(),
                        false)
                );
    }
    ...
    public static boolean isArrayIndexStartWithZero(Session session) {
        return session.getSystemProperty(ARRAY_INDEX_START_WITH_ZERO, Boolean.class);
    }
